# -*- coding: utf-8 -*-
"""
Created on Wed Jul 16 11:53:06 2025
...
def get_args():
    ...
    # Model
    parser.add_argument('--model_type', type=str2none, default='clip', choices=_MODEL_TYPE)
    ...
    # clip_download_dir
    parser.add_argument('--clip_download_dir', type=str, default='models/clip_dir', help='Directory to download CLIP that is not local.')

    parser.add_argument('--dataroot', type=str, default='preprocessing', help='Path to metadata csv file')
    parser.add_argument('--dataset_selection', type=str, default='scabies', help='Name of the dataset. e.g., matek, scabies etc.')
    parser.add_argument('--fold', type=int, default=0, help='Fold for k-fold cross-validation')
    parser.add_argument('--is_hsv', type=str2bool, default=True, help='HSV transformation')
    parser.add_argument('--is_hed', type=str2bool, default=True, help='HED transformation')
    parser.add_argument('--is_rand_aug', type=str2bool, default=True, help='Activate random augmentation')
    parser.add_argument('--is_synth_train', type=str2bool, default=False, help='Includes synthetic data or not.')
    parser.add_argument('--is_pooled_fewshot', type=str2bool, default=False, help='Different fewshots for synthetic data.')    

    parser.add_argument("--lambda_1", type=float2none, default=0.8, help="weight for loss from real/synth data")
    parser.add_argument('--n_classes', type=int, default=2)
    parser.add_argument('--is_mix_aug', type=str2bool, default=False)

    # Training/Optimization parameters
    parser.add_argument("--use_fp16", type=str2bool, default=True, help="Whether or not to use mixed precision for training.")
    parser.add_argument("--batch_size", default=64, type=int, help="Batch size per GPU. Total batch size is proportional to the number of GPUs.")
    parser.add_argument("--batch_size_eval", default=8, type=int)
    parser.add_argument("--epochs", default=100, type=int, help="Number of training epochs.")
    parser.add_argument("--wd", type=float2none, default=1e-4, help="Weight decay for the SGD optimizer.")
    parser.add_argument("--lr", default=0.1, type=float2none, help="Maximum learning rate at the end of linear warmup.")
    parser.add_argument("--warmup_epochs", default=25, type=int, help="Number of training epochs for the learning-rate-warm-up phase.")
    parser.add_argument("--min_lr", type=float, default=1e-6, help="Minimum learning rate at the end of training.")

    parser.add_argument("--output_dir", default="./output", type=str, help="Path to the output folder to save logs and checkpoints.")
    parser.add_argument("--saveckpt_freq", default=100, type=int, help="Frequency of intermediate checkpointing.")
    ...
    parser.add_argument("--local_rank", default=0, type=int, help="Please ignore this argument; No need to set it manually.")
