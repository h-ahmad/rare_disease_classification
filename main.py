...
if __name__ == "__main__":
    ...
    p.add_argument('--dataset_train', type=str, default='./generation/generate/output_lung_50_shot/lung/sd2.1/gs2.0_nis50/shot50_seed0_template1_lr0.0001_ep300/train/', help='Dataset train path.')
    ...
    p.add_argument('--dataset_val', type=str, default='./generation/generate/output_lung_50_shot/lung/sd2.1/gs2.0_nis50/shot50_seed0_template1_lr0.0001_ep300/val/', help='Dataset validation path.')
    p.add_argument('--dataset_test', type=str, default='../../../../data/rare_disease/public/lc25000_lung_colon_image_set/lung_test/', help='Dataset test path.')
    p.add_argument('--log_dir', type=str, default='output_lung_50_shot', help='Name of the folder to save the model.')
    ...
    p.add_argument('--model', type=str, default='resnet50', help='maxvit, swin, efficientnet, resnet50, mobilenetv2, densenet121, resnet101, deit_large, deit_base, volo_d1_224, clip_without_lora , clip_with_lora')
    # clip and lora setting
    p.add_argument('--dataset_name', type=str, default='colon', help='scabies, colon etc.')
